...
function AIandMl() {
  ...
  const defaults = "Artificial Intelligence/ Machine Learning";
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  return (
    <div>
      ...
      <section className="text- container  mx-auto body-font">
        <div className="">
          <p className=" mt-8 mb-8  text-2xl  text-center font-bold">
            Curriculum
          </p>
          <div className="grid md:container md:mx-auto md:grid-cols-1 lg:grid-cols-3   ">
            <div className="px-8 p-4  hover:scale-105 ease-in duration-300  lg:w-full">
              <div className="h-full  pt-2    rounded-lg  text-center relative">
                ...
                <div className="text-black text-left  pb-5">
                  <p className="flex">
                    <span className="w-fit ">✔️</span>How AI relates to ML
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span> History of AI
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span> The different stages of
                    the progress and evolution of AI
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span> Evolution &amp; progress
                    through the last 65 years (Timeline)
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span>Domain Knowledge
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span> Knowledge of Statistics
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span> Programming Language{" "}
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span> Computer Vision
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 hover:scale-110  hover:scale-105 ease-in duration-300 lg:w-full">
              <div className="h-full   px-8 pt-2  rounded-lg  text-center relative">
                ...
                <div className="text-black text-left   pb-5">
                  <p className="flex">
                    <span className="w-fit ">✔️</span> Supervised Learning
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span>Unsupervised Learning
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span> Clustering,
                    dimensionality reduction &amp; Density Estimation
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span>Virtual Assistant
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span> Product Recommendation
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 hover:scale-110  hover:scale-105 ease-in duration-300 lg:w-full">
              <div className="h-full  px-8 pt-2  rounded-lg  text-center relative">
                <p className="font-bold text-black text-left mb-4">
                  Deep Learning, Frameworks and Use cases
                </p>
                <div className="text-black text-left   pb-5">
                  <p className="flex">
                    <span className="w-fit ">✔️</span> Intro to Deep Learning
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span> Why Deep Learning
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span>Google, Facebook and
                    Microsoft Frameworks
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span> Customer Churn prediction
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span> Fraud Detection
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span> Customer Segmentation
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span> Neutral Networks-Going
                    under the hood and comparisons between the human brain &amp;
          ...
          <div className=" flex md:justify-center flex-col items-center  ">
            <div className="w-full md:w-[700px]  text-left">
              ...
              <p className=" w-full  text-black mt-4 ">
                <span className=" text-left ">✔️</span> Master Machine Learning
              </p>
            </div>
            <div className="md:w-[700px] text-left ">
              {" "}
              <p className="w-full text-black flex text-left ">
                <span className="w-fit  ">✔️</span> Make accurate predictions
              </p>
            </div>

            <div className="w-full md:w-[700px] text-left">
              <p className="w-full text-black  ">
                <span className="w-full ">✔️</span>Make Powerful Analysis
              </p>
            </div>
            <div className="w-full md:w-[700px] text-left">
              <p className="w-full text-black  ">
                <span className="w-full ">✔️</span> Know which Machine Learning
                model to choose for each type of problem
              </p>
            </div>
            <div className="w-full md:w-[700px] text-left">
              <p className="w-full text-black  ">
                <span className="w-full ">✔️</span> Create strong added value
                for your business.
              </p>
            </div>
            ...
            <div className="w-full md:w-[700px] text-left">
              <p className="w-full text-black  ">
                <span className="w-full ">✔️</span> Handle advanced techniques
            ...
            <div className="w-full md:w-[700px] text-left">
              <p className="w-full text-black  ">
                <span className="w-full ">✔️</span> Build an army of powerful
                Machine Learning models and know how to combine them to solve
                any problem
              </p>
            </div>
            ...
            <div className="w-full md:w-[700px] text-left">
              <p className="w-full text-black  ">
                <span className="w-full ">✔️</span> Use cases of AI & ML in
                Auditing
              </p>
            </div>
          </div>
        ...
        <div className="">
          ...
          <div className=" flex md:justify-center flex-col items-center  ">
            <div className="w-full md:w-[700px]  text-left">
              {" "}
              <p className=" w-full  text-black mt-4 ">
                <span className=" text-left ">✔️</span> Anyone interested in
                Machine Learning
              </p>
            </div>
            <div className="md:w-[700px] text-left ">
              {" "}
              <p className="w-full text-black flex text-left ">
                <span className="w-fit  ">✔️</span> Professionals and students
            ...
            <div className="w-full md:w-[700px] text-left">
              <p className="w-full text-black  ">
                <span className="w-full ">✔️</span>People who want to create
                added value to their business by using powerful Machine Learning
                tools.
              </p>
            </div>
            <div className="w-full mb-10 md:w-[700px] text-left">
              <p className="w-full text-black  ">
                <span className="w-full ">✔️</span> Any intermediate-level
                people who know the basics of machine learning, including the
                classical algorithms like linear regression or logistic
                regression, but who want to learn more about it and explore all
