...
function Meta() {
  ...
  return (
    <div>
      ...
      <p className="text-center  mt-4 mb-2">Introduction to META</p>
      <section className="text- container  mx-auto body-font">
        <div className="">
          <p className="text-center mt-12 mb-8 text-2xl   font-bold">
            Curriculum
          </p>
          ...
          <div className="grid md:container md:mx-auto md:grid-cols-1 lg:grid-cols-3   ">
            <div className="px-8 p-4  hover:scale-105 ease-in duration-300  lg:w-full">
              <div className="h-full  pt-2    rounded-lg  text-center relative">
                ...
                <div className="text-black text-left  pb-5">
                  <p className="flex">
                    <span className="w-fit ">✔️</span>In this module, you will
                    take your first steps into the Metaverse, exploring what it
                    is, how to interact with it, and how to communicate and
                    connect with others within it. You&#39;ll also examine the
                    ecological ramifications of the Metaverse, and the role of
                    decentralization in making the Metaverse more ethical,
            ...
            <div className="p-4 hover:scale-110  hover:scale-105 ease-in duration-300 lg:w-full">
              <div className="h-full   px-8 pt-2  rounded-lg  text-center relative">
                <p className="font-bold text-black text-left  mb-4">
                  Who is creating the Meta?
                </p>
                <div className="text-black text-left   pb-5">
                  <p className="flex">
                    <span className="w-fit ">✔️</span> In this module, you will
                    explore how the Meta verse will be made by identifying the
                    architects of the Meta verse, as well as the devices,
                    platforms, and game engines they will use to build it and
                    you will use to interact with it. You will also explore how
                    extended reality (XR) is used in the Meta verse and the role
            ...
            <div className="p-4 hover:scale-110  hover:scale-105 ease-in duration-300 lg:w-full">
              <div className="h-full  px-8 pt-2  rounded-lg  text-center relative">
                ...
                <div className="text-black text-left   pb-5">
                  <p className="flex">
                    <span className="w-fit ">✔️</span> In this module, you will
                    explore how the Metaverse will impact various verticals,
                    including education, healthcare, city planning, and civic
                    engagement. You will also examine what communication,
                    marketing, and design will look like in the Metaverse, and
                    what it will mean to engage with art, entertainment, and
          ...
          <div className=" flex md:justify-center flex-col items-center  ">
            <div className="w-full md:w-[700px]  text-left">
              ...
              <p className=" w-full flex  text-black mt-4 ">
                <span className=" text-left ">✔️</span> Entry-level Metaverse
                certification training has no prior eligibility criteria to be
                part of the training or to sit for the respective exam. However,
                if candidates are looking to get trained in the advanced level
                Metaverse certification exam, they need to sit for the
                foundation level first to be eligible.
              </p>
            </div>
            <p>
