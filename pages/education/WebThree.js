        ...
        <div className="w-full    h-full  flex  justify-center">
          <div className="text-white relative   max-auto  h-full flex flex-col justify-center items-center">
            ...
            <p className="text-lg mt-4 flex  gap-8 ">
              ...
              <span className="font-bold">
                Duration:<span className="font-semibold"> 8 Hours </span>{" "}
              </span>{" "}
              <span className="font-bold">
          ...
          <div className="grid md:container md:mx-auto md:grid-cols-1 lg:grid-cols-3   ">
            <div className="px-8 p-4  hover:scale-105 ease-in duration-300  lg:w-full">
              <div className="h-full  pt-2    rounded-lg  text-center relative">
                ...
                <div className="text-black text-left  pb-5">
                  <p className="flex">
                    <span className="w-fit ">✔️</span>Introduction to Web 3.0
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span> How to Move from Web 2.0
                    to Web 3.0
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span> The Characteristics of
                    Web 3.0
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span> What Is the Mechanics of
                    Web 3.0
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span>What Comes After Web
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span> What Is Semantic Web –
                    The Concept Behind Web 3.0
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 hover:scale-110  hover:scale-105 ease-in duration-300 lg:w-full">
              <div className="h-full   px-8 pt-2  rounded-lg  text-center relative">
                ...
                <div className="text-black text-left   pb-5">
                  <p className="flex">
                    <span className="w-fit ">✔️</span> Consensus Mechanisms and
                    Key Concepts
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span> Consensus Mechanisms and
                  ...
                  <p className="flex">
                    <span className="w-fit ">✔️</span> Smart Contracts and
                    Ethereum
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span> dApps, DAOs, and NFTs
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span> Oracle Problem and
                    Decentralized Oracle
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span> Blockchain Scalability
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span> White paper Reading
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span> User Interaction with
                    Bitcoin
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span> Bridges
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span>Storages
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 hover:scale-110  hover:scale-105 ease-in duration-300 lg:w-full">
              <div className="h-full  px-8 pt-2  rounded-lg  text-center relative">
                ...
                <div className="text-black text-left   pb-5">
                  <p className="flex">
                    <span className="w-fit ">✔️</span> IT Fundamentals for
                    Blockchain
                  </p>
                  <p className="flex">
                  ...
                  <p className="flex">
                    <span className="w-fit ">✔️</span> Javascript
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span> Solidity
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span> Web 3.0 Development
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span> The Graph
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span> GraphQL
                  </p>
                  <p className="flex">
                    <span className="w-fit ">✔️</span>Chain link
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className=" flex md:justify-center flex-col items-center ">
            <div className="w-full md:w-[500px]  text-left">
              ...
              <p className=" w-full  text-black mt-4 ">
                <span className=" text-left ">✔️</span> Data Ownership
              </p>
            </div>
            <div className="md:w-[500px] text-left ">
              {" "}
              <p className="w-full text-black flex text-left ">
                <span className="w-fit  ">✔️</span> Greater Accessibility
              </p>
            </div>

            <div className="w-full md:w-[500px] text-left">
              <p className="w-full text-black  ">
                <span className="w-full ">✔️</span>Elimination of Centralized
                Authority Course Outcome
              </p>
            </div>
            <div className="w-full md:w-[500px] text-left">
              <p className="w-full text-black  ">
            ...
            <div className="w-full md:w-[500px] text-left">
              <p className="w-full text-black  ">
                <span className="w-full ">✔️</span> Metaverse
              </p>
            </div>
            <div className="w-full md:w-[500px] text-left">
              <p className="w-full text-black ">
                <span className="w-full ">✔️</span> Decentralized browsers
              </p>
            </div>
            <div className="w-full md:w-[500px] text-left">
              <p className="w-full text-black  ">
                <span className="w-full ">✔️</span> Decentralized Cloud storage
              </p>
            </div>
            <div className="w-full md:w-[500px] text-left">
              <p className="w-full  text-black  ">
          ...
          <div className=" flex md:justify-center flex-col items-center ">
            <div className="w-full md:w-[500px]  text-left">
              ...
              <p className=" w-full flex text-black mt-4 ">
                <span className=" text-left ">✔️</span> There is no experience
                or previous qualifications required for enrolment on this
                course. It is available to all students of all academic
                backgrounds.
              </p>
            </div>
            <div className="md:w-[500px] text-left ">
